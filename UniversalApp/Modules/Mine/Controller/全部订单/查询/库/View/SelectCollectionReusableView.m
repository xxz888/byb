...
- (id) initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UILabel* label = [[UILabel alloc] initWithFrame:CGRectMake(16.0f, (self.frame.size.height - 18.0f / 2), 100.0f, 18)];
        ...
        [delectButton.titleLabel setTextAlignment:NSTextAlignmentLeft];
