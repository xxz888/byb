...
@interface JDSelectOddViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UITextFieldDelegate>
...
@implementation JDSelectOddViewController
...
-(void)commonAction:(JDSelectSpModel *)spModel VC:(JDAddSpViewController *)VC{
    //每点击一次，就加一个model
