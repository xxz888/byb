//
//  JDJiaGongShouHuo2ViewController.m
//  UniversalApp
//
...
#import "JDJiaGongShouHuo2ViewController.h"
...
@interface JDJiaGongShouHuo2ViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UITextFieldDelegate>
...
@implementation JDJiaGongShouHuo2ViewController
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    JDJiaGongShouHuo3ViewController * VC = [stroryBoard instantiateViewControllerWithIdentifier:@"JDJiaGongShouHuo3ViewController"];
    ...
    if (AD_MANAGER.sectionArray.count > 0) {
        ...
        if (AD_MANAGER.sectionArray.count > 0) {
            [AD_MANAGER.sectionArray removeObjectAtIndex:0];
        }
