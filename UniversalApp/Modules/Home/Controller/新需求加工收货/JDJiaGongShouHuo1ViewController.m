//
//  JDJiaGongShouHuo1ViewController.m
//  UniversalApp
//
...
@interface JDJiaGongShouHuo1ViewController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
...
@implementation JDJiaGongShouHuo1ViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [AD_MANAGER.affrimDic setValue:@(model.gysid) forKey:@"gysid"];

    UIStoryboard * stroryBoard = [UIStoryboard storyboardWithName:@"JiaGongShouHuo" bundle:nil];
    JDJiaGongShouHuo2ViewController * VC = [stroryBoard instantiateViewControllerWithIdentifier:@"JDJiaGongShouHuo2ViewController"];
