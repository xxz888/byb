//
//  JDSalesAffirmTableViewController.m
//  UniversalApp
//
...
@interface JDSalesAffirmTableViewController ()<UITextViewDelegate,UITextFieldDelegate>
/** 动态cell的数据源 */
...
@implementation
JDSalesAffirmTableViewController
...
-(void)allUIControlGetValue{
    ...
    [self.btn1 setTitle:CaiGouBOOL ? AD_MANAGER.affrimDic[@"gysmc"] : AD_MANAGER.affrimDic[@"khmc"] forState:0];
    ...
    if (ORDER_ISEQUAl(YuDingDan)) {
        ...
        view.selectedBlock = ^(NSArray<SelectedListModel *> *array) {
            [LEEAlert closeWithCompletionBlock:^{
                ...
                [AD_MANAGER.affrimDic setValue:model.title forKey:@"shrmc"];
