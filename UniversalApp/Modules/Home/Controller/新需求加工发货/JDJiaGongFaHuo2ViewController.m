//
//  JDJiaGongFaHuo2ViewController.m
//  UniversalApp
//
...
@interface JDJiaGongFaHuo2ViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UITextFieldDelegate>
...
@implementation JDJiaGongFaHuo2ViewController
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    JDJiaGongFaHuo3ViewController * VC = [stroryBoard instantiateViewControllerWithIdentifier:@"JDJiaGongFaHuo3ViewController"];
    ...
    VC.oddCome = @"oddVC";
    [self commonAction:VC.spModel VC:VC];
}
-(void)commonAction:(JDSelectSpModel *)spModel VC:(JDJiaGongFaHuo3ViewController *)VC{
    //每点击一次，就加一个model
