//
//  JDYuanLiaoRuKuTableViewController.m
//  UniversalApp
//
...
@interface JDYuanLiaoRuKuTableViewController ()<UITextViewDelegate,UITextFieldDelegate>
/** 动态cell的数据源 */
...
@implementation JDYuanLiaoRuKuTableViewController
...
- (IBAction)zhijiefachangAction:(id)sender {
    ...
    view.selectedBlock = ^(NSArray<SelectedListModel *> *array) {
        [LEEAlert closeWithCompletionBlock:^{
            ...
            //仓库
            [AD_MANAGER.affrimDic setValue:@(model.sid) forKey:@"zjfc"];
