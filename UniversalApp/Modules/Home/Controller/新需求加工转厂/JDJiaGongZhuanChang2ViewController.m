//
//  JDJiaGongZhuanChang2ViewController.m
//  UniversalApp
//
...
@interface JDJiaGongZhuanChang2ViewController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
...
@implementation JDJiaGongZhuanChang2ViewController
...
- (void)viewDidLoad {
    ...
    self.title =  @"选择转入工厂" ;
    self.searchTf.placeholder = @"请输入转入工厂..." ;
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    JDSelectClientModel * model  = AD_MANAGER.selectKhPageArray[indexPath.row];
    [AD_MANAGER.affrimDic setValue:model.gysmc forKey:@"gysmcIn"];
    [AD_MANAGER.affrimDic setValue:@(model.gysid) forKey:@"gysmcInId"];
