//
//  JDJiaGongZhuanChang1ViewController.m
//  UniversalApp
//
...
#import "JDJiaGongZhuanChang2ViewController.h"

@interface JDJiaGongZhuanChang1ViewController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
...
@implementation JDJiaGongZhuanChang1ViewController
...
- (void)viewDidLoad {
    ...
    self.title =  @"选择转出工厂" ;
    self.searchTf.placeholder = @"请输入转出工厂..." ;
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    JDSelectClientModel * model  = AD_MANAGER.selectKhPageArray[indexPath.row];
    [AD_MANAGER.affrimDic setValue:model.gysmc forKey:@"gysmcOut"];
    [AD_MANAGER.affrimDic setValue:@(model.gysid) forKey:@"gysmcOutId"];

    UIStoryboard * stroryBoard = [UIStoryboard storyboardWithName:@"JiaGongZhuanChang" bundle:nil];
    JDJiaGongZhuanChang2ViewController * VC = [stroryBoard instantiateViewControllerWithIdentifier:@"JDJiaGongZhuanChang2ViewController"];
