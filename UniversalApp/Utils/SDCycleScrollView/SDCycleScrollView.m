...
- (void)initialization
{
    ...
    self.backgroundColor = JDRGBAColor(247, 249, 251);
...
//            CGFloat fixelW = CGImageGetWidth(imagea.CGImage);
//            CGFloat fixelH = CGImageGetHeight(imagea.CGImage);
//            cell.imageView.image = [self harfWithImage:imagea toSize:CGSizeMake(fixelW/2, fixelH/2)];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.delegate respondsToSelector:@selector(cycleScrollView:didSelectItemAtIndex:imageView:)]) {
        [self.delegate cycleScrollView:self didSelectItemAtIndex:[self pageControlIndexWithCurrentCellIndex:indexPath.item] imageView:cell.imageView];
    }
