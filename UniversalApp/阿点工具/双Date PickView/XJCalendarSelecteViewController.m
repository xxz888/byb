...
- (void)loadAllView{
    ...
    [btn setTitleColor:kRGBColor(0, 163, 255) forState:UIControlStateNormal];
...
- (void)setIsEndTime:(BOOL)isEndTime{
    ...
    if (_isEndTime) {
        ...
        [_endTimeButton setTitleColor:kRGBColor(0, 163, 255) forState:UIControlStateNormal];
        _endBottomView.backgroundColor = kRGBColor(0, 163, 255);
    }else{
        [_startTimeButton setTitleColor:kRGBColor(0, 163, 255) forState:UIControlStateNormal];
        _startBottomView.backgroundColor = kRGBColor(0, 163, 255);
