...
//    UIImageView * bottomView = [[UIImageView alloc]initWithFrame:CGRectMake(0, navBar.frame.size.height - 1 + 44, KScreenWidth,0)];
//    bottomView.backgroundColor = JDRGBAColor(235, 235, 235);
